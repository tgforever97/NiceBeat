...
val projectName = "NiceBeat"
val projectVersion = "2019.02.12"

resolvers += Resolver.sonatypeRepo("snapshots")


val projectMainClass = "com.neo.sk.NiceBeat.Boot"
...
lazy val backend = (project in file("backend")).enablePlugins(PackPlugin)
  ...
  .settings(
    ...
    packMain := Map("NiceBeat" -> projectMainClass),
    packJvmOpts := Map("NiceBeat" -> Seq("-Xmx512m", "-Xms128m")),
    packExtraClasspath := Map("NiceBeat" -> Seq("."))
  )
  .settings(
